...
class EntityMediator:
    ...
    @staticmethod
    def __give_score(bomb: Bomb, entity_list: list[Entity]):
        if bomb.last_dmg == 'Player1Shot':
            for ent in entity_list:
                if ent.name == 'Player1':
                    ent.score += bomb.score
        elif bomb.last_dmg == 'Player2Shot':
            for ent in entity_list:
                if ent.name == 'Player2':
                    ent.score += bomb.score
